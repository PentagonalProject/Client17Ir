 ...
 * @method void         createSavepoint($savepoint)
 *
 * @method int delete($tableExpression, array $identifier, array $types = [])
 *
 * @method int       errorCode()
 * @method array     errorInfo()
 * @method void      exec($statement)
 * @method Statement executeQuery($query, array $params = [], array $types = [], QueryCacheProfile $qcp = null)
 * @method ResultStatement executeCacheQuery($query, $params, $types, QueryCacheProfile $qcp)
 * @method int       executeUpdate($query, array $params = [], array $types = [])
 *
 * @method int  insert($tableExpression, array $data, array $types = [])
 * @method bool isAutoCommit()
 * @method bool isConnected()
 * @method bool isRollbackOnly()
 * @method bool isTransactionActive()
 *
 * @method array fetchAssoc($statement, array $params = [], array $types = [])
 * @method array fetchArray($statement, array $params = [], array $types = [])
 * @method array fetchColumn($statement, array $params = [], array $types = [])
 * @method array fetchAll($sql, array $params = array(), $types = array())
 *
 ...
 *
 * @method bool      ping()
 * @method Statement prepare($statement)
 * @method array     project($query, array $params, \Closure $function)
 *
 * @method void      releaseSavepoint($savePoint)
 * @method array     resolveParams(array $params, array $types)
 * @method bool|void rollBack()
 * @method void      rollbackSavepoint($savePoint)
 *
 ...
 *
 * @method int update($tableExpression, array $data, array $identifier, array $types = [])
 *
 * @method string    quote(mixed $input, int $type = \PDO::PARAM_STR)
 * @method string    quoteIdentifier($str)
 *
 * @uses \PDO::ATTR_DEFAULT_FETCH_MODE for (19)
 * @method Statement query($sql, int $mode = 19, mixed $additionalArg = null, array $constructorArgs = [])
 */
class Database
{
    /**
